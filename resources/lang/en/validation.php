<?php return array(
    ...
    'ProgramTitle.required' => 'The Program Title field is required',
    'ProgramTitle.max:15' => 'The Program Title  is max 15 Character',
    'ProgramTitle.unique' => 'The Program Title must be Unique',
    'subtitle.required' => 'The Subtitle field is required',
    'subtitle.max:20' => 'The Subtitle field is max 20 Character',
    'totalcost.required' => 'The Total Cost field is required',
    'requirements.required' => 'The Requirements field is required',
    'allcourses.required' => 'The Courses field is required',
    'Payment_plan.required' => 'The Payment plan field is required',
    'high_school.required' => 'The High School field is required',
    'school_years_attended.required' => 'The School Years Attended field is required',
    'school_year_graduate.required' => 'The School Year Graduate field is required',
    'school_degree.required' => 'The School Degree field is required',
    'college.required' => 'The College field is required',
    'college_email.required' => 'The College Email field is required',
    'college_graduate.required' => 'The College Graduate field is required',
    'trade_school.required' => 'The Trade School field is required',
    'trade_degree.required' => 'The Trade Degree field is required',
    'trade_years_attended.required' => 'The Trade Years Attended field is required',
    'trade_year_graduate.required' => 'The Trade Year Graduate field is required',
    'upload_resume.required' => 'The Upload Resume field is required',
    'cover.required' => 'The Cover field is required',
    'date_of_birth.required' => 'The Date Of Birth field is required',
    'instructor_position_id.required' => 'The Instructor position field is required',
    'instructor_hear_id.required' => 'The Instructor Hear field is required',
    'term_one_text' => 'The Term One Text field is required',
    'invoice_date_one' => 'The Invoice Date One field is required',
    'invoice_date_two' => 'The Invoice Date Two field is required',
    'term_two_text' => 'The Term  field is required',
    ...
    'credit_card_no.required' => 'The Credit Card field is required',
    'exp_date.required' => 'The Exp_date field is required',
    'card_appears_name.required' => 'The Card Appears Name field is required',
    'digit_on_back.required' => 'The Digit On Back field is required',
    'dollar_amount.required' => 'The Dollar Amount field is required',
    'stgnature.required' => 'The Signature field is required',
    'paid_bill_date.required' => 'The Paid Bill Date field is required',
    'paid_bill.required' => 'The Paid Bill field is required',
    'student_signature.required' => 'The Student Signature field is required',
    'student_signature_date.required' => 'The Student Signature Date field is required',
    'applican_name.required' => 'The Applicant Name field is required',
    'authorized_representative.required' => 'The Authorized Representative field is required',
    ...
    'by.required' => 'The by field is required',
    'whose_identity.required' => 'The Whose Identity field is required',
    'notary_signature.required' => 'The Notary Signature field is required',
    'printed_name.required' => 'The Printed Name field is required',
    'f_name.required' => 'The first name field is required',
    'l_name.required' => 'The last name field is required',
    'SS.required' => 'The SS field is required',
    'mailing_address.required' => 'The Mailing Address field is required',
    'program_review.required' => 'The Program Review field is required',
    'cna_prep_price.required_if' => 'The CNA PREP PRICE field is required if CnaPrep is checked',
    'test_prep_price.required_if' => 'The TEST PREP PRICE(ON-DEMAND) field is required if Test-Prep(on-demand) is checked',
    'test_prep_graded_price.required_if' => 'The TEST PREP PRICE(GRADED) field is required if Test-Prep(graded) is checked',
