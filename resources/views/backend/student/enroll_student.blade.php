                    ...
                    <ul class="nav nav-tabs no-bottom-border  mt-sm-md-20 mb-10 ml-3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if(!session()->get('type')) active @endif"
                               href="#group_email_sms" role="tab" data-toggle="tab">{{ __('Programs') }}</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link @if(session()->get('type') == 2) active @endif"
                               href="#indivitual_email_sms" role="tab"
                               data-toggle="tab">{{ __('Test-Prep') }}</a>
                        </li>
                                                    ...
                                                    <div class="col-xl-12 col-md-12 col-lg-12">
                                                        <div class="primary_input ">
                                                            <label class="primary_input_label"
                                                                   for="courseSelect">{{__('common.Select')}} {{__('Program')}}</label>
                                                        </div>
                                                        <select class="primary_select" name="program" id="courseSelect">
                                                            <option
                                                                data-display="{{__('common.Select')}} {{__('Program')}}"
                                                                value="">{{__('common.Select')}} {{__('Program')}}</option>

                                                            @foreach($programs as $program)
                                                                <option
                                                                    value="{{$program->id}}" {{isset($programId)?$programId==$program->id?'selected':'':''}}>{{$program->programtitle}} </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="QA_section QA_section_heading_custom check_box_table">
                                            <div class="QA_table ">
                                                ...
                                                <div class="">
                                                    <table id="lms_table1" class="table Crm_table_active3">
                                                        <thead>
                                                        <tr>
                                                            <th scope="col">{{__('common.SL')}} </th>
                                                            <th scope="col">{{__('common.Image')}} </th>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="mt-40 d-flex justify-content-between">
                            <button type="button" class="primary-btn tr-bg"
                                    data-dismiss="modal">{{__('common.Cancel')}}</button>
                            <a id="delete_link_program" class="primary-btn semi_large2 fix-gr-bg">{{__('common.Delete')}}</a>
...
@push('scripts')
    ...
    <script>
        ...
        function confirm_cancel_program_modal(delete_url) {
            jQuery('#confirm_cancel_delete_program').modal('show', {backdrop: 'static'});
