...
@section('mainContent')
    ...
    <section class="sms-breadcrumb white-box mb-40">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>{{ __('student.Canceled Student') }}</h1>
                <div class="bc-pages">
                    <a href="{{ route('dashboard') }}">{{ __('dashboard.Dashboard') }}</a>
                    <a href="#">{{ __('student.Students') }}</a>
                    <a href="#">{{ __('student.Canceled Student') }}</a>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <ul class="nav nav-tabs no-bottom-border mt-sm-md-20 mb-10 ml-3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if (session()->get('type') == 2) active @endif" href="#indivitual_email_sms"
                                role="tab" data-toggle="tab">{{ __('Test-Prep') }}</a>
                        </li>
                ...
                <div class="row mt_0_sm">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade @if (!session()->get('type')) show active @endif"
                                id="group_email_sms">
                                ...
                                <div class="row justify-content-center mt-50">
                                    <div class="col-lg-12">
                                        <div class="white_box mb_30">
                                            ...
                                            <form action="{{ route('admin.cancelLogs') }}" method="GET">
                                                    ...
                                                    <table id="lms_table" class="Crm_table_active3 table">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th scope="col">{{ __('Program') }}
                                                                    {{ __('courses.Canceled') }}</th>
                                                                <th scope="col">{{ __('common.Price') }}</th>
                                                                <th scope="col">{{ __('courses.Canceled') }}
                                                                    {{ __('common.Date') }} </th>
                            ...
                            <div role="tabpanel" class="tab-pane fade @if (session()->get('type') == 2) show active @endif"
                                    ...
                                    <div class="container-fluid p-0">
                                        <div class="row justify-content-center mt-50">
                                            <div class="col-lg-12">
                                                <div class="white_box mb_30">
                                                    <div class="white_box_tittle list_header">
                                                        <h4>{{ __('student.Filter Cancel History') }}</h4>
                                                    </div>
                                                    <form action="{{ route('admin.cancelLogs') }}" method="GET">
                                            ...
                                            <div class="col-12">
                                                <div class="box_header common_table_header">
                                                    <div class="main-title d-md-flex">
                                                        <h3 class="mr-30 mb_xs_15px mb_sm_20px mb-0">
                                                            {{ __('student.Canceled Student') }} {{ __('common.List') }}
                                                        </h3>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="QA_section QA_section_heading_custom check_box_table">
                                                    <div class="QA_table">
                                                        ...
                                                        <div class="">
                                                            <table id="lms_table1" class="Crm_table_active3 table">
                                                                <thead>
                                                                    <tr>
                                                                        <th scope="col">{{ __('common.SL') }} </th>
                                                                        <th scope="col">{{ __('common.Image') }} </th>
                                                                        <th scope="col">{{ __('common.Name') }} </th>
                                                                        <th scope="col">
                                                                            {{ __('common.Email Address') }} </th>
                                                                        <th scope="col">{{ __('Test-Prep') }}
                                                                            {{ __('courses.Canceled') }}</th>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-center">
                        {{ __('Student can not access Test-Prep anymore') }}.
                    </p>
                    <p class="text-center">
    ...
    <div class="modal fade admin-query" id="confirm_delete">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3 class="text-center">{{ __('Are you sure to Delete') }}?</h3>
                    <p class="text-center">
                        {{ __('This Data will be lost') }}.
                    </p>
                    <div class="col-lg-12 text-center">
                        <div class="d-flex justify-content-between mt-40">
                            <button type="button" class="primary-btn tr-bg"
...
@push('scripts')
    ...
    @php
        $url = route('admin.getCancelProgramLogsData') . '?program=' . $programId;
        $url1 = route('admin.getCancelLogsData') . '?course=' . $courseId . '&start_date=' . $start . '&end_date=' . $end;
    ...
    <script>
        ...
        function confirm_delete_modal(delete_url) {
    ...
    @if (\Illuminate\Support\Facades\Auth::user()->role_id != 2)
        <script>
            let table = $('#lms_table1').DataTable({
                bLengthChange: true,
                "lengthChange": true,
                "lengthMenu": [
                    [10, 25, 50, 100, -1],
    ...
    @endif
    <script>
        let table1 = $('#lms_table').DataTable({
            bLengthChange: true,
            "lengthChange": true,
            "lengthMenu": [
                [10, 25, 50, 100, -1],
