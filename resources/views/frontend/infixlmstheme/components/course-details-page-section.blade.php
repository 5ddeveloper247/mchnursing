            ...
            <div class="row justify-content-center ">
                <div class="col-xl-10">
                    <div class="course__details_title">
                        <div class="single__details ml-5">
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-8">
                            <div class="course_tabs text-center">
                                <ul class="w-200 nav lms_tabmenu justify-content-between  mb_55" id="myTab"
                                    role="tablist">
                                    <li class="nav-item">
...
{{--                                                                                                    data-url="{{route('quizStart',[$course->id,$quiz->id,$quiz->title])}}"--}}
                                                                                    ...
                                                                                    <span
                                                                                        ...
                                                                                        @else
                                                                                            ...
                                                                                            <i class="ti-control-play"></i>
                                                                                            <span
                                                                                                onclick="goFullScreen({{$course->id}},{{$lesson->id}},{{$request->program_id ?? 0}},{{$request->courseType ?? 0}})">{{@$key+1}} {{@$lesson->name}}</span>
                                                                                        @endif
                                                                                    @else
                                                                                        <i class="ti-lock"></i>
                                                                                        @if ($lesson->is_quiz==1)
...
{{--                                                                                                data-url="{{route('quizStart',[$course->id,$quiz->id,$quiz->title])}}"--}}
                                        ...
                                        @if(count($course_exercises)!=0)
                                            <div class="theme_according mb_30" id="accordion0">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="show collapse" id="collapse"
                                                         aria-labelledby="heading" data-parent="#accordion1">
                                                        <div class="card-body">
                                                            <div class="curriculam_list">
                                ...
                                <div class="tab-pane fade " id="Classes" role="tabpanel"
                                     aria-labelledby="Curriculum-tab">
                                    <!-- content  -->
                                    <h4 class="font_22 f_w_$program_plan700 mb_20">{{__('Classes')}}</h4>
                                    <div class="theme_according mb_30" id="accordion1">
                                        <div class="row">
                                            @if($request->has('program_id'))
                                                @if(\Carbon\Carbon::parse($program_plan->cdate)->format('Y-m-d') < \Carbon\Carbon::now()->format('Y-m-d'))
                                                    @if(count($Classes))
                                                        @foreach($Classes as $Class)

                                                            <div class="col-lg-6 col-xl-4">
                                                                <div class="couse_wizged">
                                                                    <a href="{{courseDetailsUrl(@$Class->id,@$Class->type,@$Class->slug).'?program_id='.$request->program_id}}">
                                                                        <div class="thumb">
                                            ...
                                            @else
                                                @if(count($Classes))
                                                    @foreach($Classes as $Class)
                                                        ...
                                                        <div class="col-lg-6 col-xl-4">
                                                            <div class="couse_wizged">
                                                                <a href="{{courseDetailsUrl(@$Class->id,@$Class->type,@$Class->slug).'?courseType='.$request->courseType.'&course_id='.$course->id}}">
                                                                    <div class="thumb">
                                ...
                                <div class="tab-pane fade " id="Timetable" role="tabpanel"
                                     aria-labelledby="Curriculum-tab">
                                    <!-- content  -->
                                    <h4 class="font_22 f_w_$program_plan700 mb_20">{{__('Time Table')}}</h4>
                                    <div class="theme_according mb_30" id="accordion1">
...
{{--                                                <li>--}}
{{--                                                    <button class="theme_btn d-block text-center printBtn">{{__('student.Print')}}</button>--}}
{{--                                                </li>--}}
                                                <li>
                                                    <s class="theme_btn d-block text-center my-2 printBtn">{{__('student.Print')}}</s>
                                                    <a class="theme_line_btn d-block text-center downloadBtn " style="cursor:pointer;">{{__('student.Download')}}</a>
...
{{--                                                    </li>--}}
                                                    <li>
                                                        <a href="{{!empty($course->parent_id) ? route('buyNowQuiz',[@$course->id]).'?courseType='.$request->courseType:route('buyNowQuiz',[@$course->id])}}" class="theme_line_btn d-block text-center">{{__('student.Download')}}</a>
                                ...
                                @if(!onlySubscription())
                                    @if (Auth::check())
                                        @if ($isEnrolled)
                                            ...
                                            @endif
                                            @if(request()->has('courseType') || request()->courseType == 4 || request()->courseType == 5)
                                        ...
                                        @else
                                            ...
                                            @if($is_cart == 1)
                                                <a href="javascript:void(0)"
                                                   class="theme_btn d-block text-center height_50 mb_10">{{__('common.Added To Cart')}}</a>
                                            @else
                                                <a href=" {{!empty($course->parent_id) ? route('addToCartQuiz',[@$course->id]).'?courseType='.$request->courseType : route('addToCartQuiz',[@$course->id])}}"
                                                   class="theme_btn d-block text-center height_50 mb_10">{{__('common.Add To Cart')}}</a>
                                            @endif
