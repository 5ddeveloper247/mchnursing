                        ...
                        <div class="{{onlySubscription()?"col-xl-12 col-lg-12":"col-xl-8 col-lg-8"}}">
                            ...
                            <div class="tab-content lms_tab_content" id="myTabContent">
                                <div class="tab-pane fade show active " id="Overview" role="tabpanel"
                                    ...
                                    <div class="course_overview_description">
                                            ...
                                            <div class="col-12">
                                                <div class="description_grid">
                                                    ...
                                                    @else
                                                        ...
                                                        @php
                                                            $date = strtotime('next '.strtolower(date('l', strtotime($course->class->start_date))));
                                                        @endphp
                                                        <div class="single_description_grid">
                                                            <h5> {{__('common.Start Date & Time')}}</h5>
                                                            <p>

                                                                @if($course->class->time <= Carbon\Carbon::now()->format('H:i:s') && Carbon\Carbon::now()->format('H:i:s') <= $course->class->end_time)
                                                                    {{ date('dS D, Y') }}
                                                                @elseif (Carbon\Carbon::now()->format('H:i:s') < $course->class->end_time)
                                                                    {{ date('dS D, Y') }}
                                                                @else
                                                                    {{date('dS D, Y',$date)}}
                                                                @endif
                                        ...
                                        <div class="single_overview">
                                            <h4 class="font_22 f_w_700 mb_20">{{__('Class Description')}}</h4>
                                ...
                                <div class="tab-pane fade " id="Curriculum" role="tabpanel"
                                    ...
                                    <!-- content  -->
                                    <h4 class="font_22 f_w_700 mb_20">{{__('CLass Schedule')}}</h4>
                                ...
                                <div class="tab-pane fade " id="Instructor" role="tabpanel"
                                    ...
                                    {{--                                            <h3>{{__('More Quizzes by Author')}}</h3>--}}
                                    {{--                                        </div>--}}
                                    {{--                                        <div class="row">--}}
