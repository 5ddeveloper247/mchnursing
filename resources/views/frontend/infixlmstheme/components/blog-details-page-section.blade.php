                    ...
                    <div class="blog_reviews">
                        ...
                        <div class="blog_reviews_inner">
                            ...
                            @foreach ($blog->comments as $comment)
                                ...
                                <div class="replyBox d-none inputForm reply_form_{{ @$comment->id }} w-100 pr-0">
                                    ...
                                    <form action="{{ route('blogCommentSubmit') }}" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            @guest()
                                                <div class="col-lg-6">
                                                    ...
                                                    <input name="name" placeholder="{{ __('common.Enter Full Name') }}"
                                                        ...
                                                        class="primary_input5 bg_style1" required="" type="text">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <input name="email"
                                                        ...
                                                        class="primary_input5" required="" type="email">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <textarea name="comment" placeholder="{{ __('common.Write your comments here') }}…" onfocus="this.placeholder = ''"
                                                    onblur="this.placeholder = '{{ __('common.Write your comments here') }}…'" class="primary_textarea5"
                                                    required=""></textarea>
