        ...
        <div class="col-lg-12">
            ...
            <div class="white-box p-0">
                <div class="add-visitor certificate">
                    <div class="row mt-15 padding_30 padding_40">
                        <div class="col-xl-12">
                    ...
                    <div class="row mt-25 padding_40">
                        <div class="col-md-12">
                            <label class="primary_input_label"
                                   for=""> {{__('certificate.Show Title')}}</label>
                        </div>
                        <div class="col-md-6 mb-25">
                            <label for="show_title_yes" class="primary_checkbox d-flex mr-12">
                                <input onclick="getNew()" type="radio"
                                       class="common-checkbox show_title" name="show_title" id="show_title_yes" checked
                                       value="1" {{isset($certificate) && $certificate->show_title==1?"checked":""}}>
                                <span class="checkmark mr-2"></span> {{__('certificate.Yes')}}</label>
                        </div>
                        <div class="col-md-6 mb-25">
                            <label for="show_title_no" class="primary_checkbox d-flex mr-12">
                                <input onclick="getNew()" type="radio"
                                       class="common-checkbox show_title" name="show_title" id="show_title_no"
                                       value="0" {{isset($certificate) && $certificate->show_title!=1?"checked":""}}>

                                <span class="checkmark mr-2"></span> {{__('certificate.No')}}</label>
                        </div>
                    </div>
                    ...
                    @if(isModuleActive('Org'))
                        ...
                        <div class="row mt-25 padding_40">
                            <div class="col-md-12">
                                <label class="primary_input_label"
                                       for=""> {{__('certificate.Show Org Chart Name')}}</label>
                            </div>
                            <div class="col-md-6 mb-25">
                                <label for="show_org_chart_yes" class="primary_checkbox d-flex mr-12">
                                    <input onclick="getNew()" type="radio"
                                           class="common-checkbox show_org_chart" name="show_org_chart"
                                           id="show_org_chart_yes" checked
                                           value="1" {{isset($certificate) && $certificate->show_org_chart==1?"checked":""}}>
                                    <span class="checkmark mr-2"></span> {{__('certificate.Yes')}}</label>
                            </div>
                            <div class="col-md-6 mb-25">
                                <label for="show_org_chart_no" class="primary_checkbox d-flex mr-12">
                                    <input onclick="getNew()" type="radio"
                                           class="common-checkbox show_org_chart" name="show_org_chart"
                                           id="show_org_chart_no"
                                           value="0" {{isset($certificate) && $certificate->show_org_chart!=1?"checked":""}}>
                            ...
                            <div class="col-lg-6">
                                <div class="input-effect">
                                    ...
                                    <input type="number" required
                                           ...
                                           placeholder="{{__('certificate.Position Y')}}" id="org_chart_x"
                            ...
                            <div class="col-md-12">
                                <div class="input-effect">
                                    ...
                                    <select class="primary_select title_font_family" onchange="getNew()"
                                            ...
                                            name="org_chart_font_family">
                                        @foreach($font_list as $key=>$value)
                                            <option
                                                value="{{$key}}" {{isset($certificate)?$certificate->org_chart_font_family==$key?'selected':'':''}}>
                                                {{$value}}
                                            </option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="row mt-25 padding_40">
                        ...
                        <div class="col-md-6 mb-25">
                            ...
                            >
                                ...
                                <span class="checkmark mr-2"></span> {{__('certificate.Yes')}}
                            </label>
                        </div>
                        <div class="col-md-6 mb-25">
                    ...
                    <div class="row mt-25 padding_40">
                        <div class="col-md-12">
                            <label class="primary_input_label"
                                   for=""> {{__('certificate.Show QR')}}</label>
                        </div>
                        <div class="col-md-6 mb-25">
                            <label for="qr_yes" class="primary_checkbox d-flex mr-12">
                                <input onclick="getNew()" type="radio"
                                       class="common-checkbox qr" name="qr" id="qr_yes" checked
                                       value="1" {{isset($certificate) && $certificate->qr==1?"checked":""}}>
                                <span class="checkmark mr-2"></span> {{__('certificate.Yes')}}</label>
                        </div>
                        <div class="col-md-6 mb-25">
                            <label for="qr_no" class="primary_checkbox d-flex mr-12">
                                <input onclick="getNew()" type="radio"
                                       class="common-checkbox qr" name="qr" id="qr_no"
                                       value="0" {{isset($certificate) && $certificate->qr!=1?"checked":""}}>
                    ...
                    <div class="row mt-25 padding_40">
                        <div class="col-md-12">
                            <label class="primary_input_label"
                                   for=""> {{__('certificate.Certificate Number Show')}}</label>
                        </div>
                        <div class="col-md-6 mb-25">
                            <label for="yes12" class="primary_checkbox d-flex mr-12">
                                <input onclick="getNew()" type="radio" checked
                                       class="common-checkbox certificate_no" name="certificate_no" id="yes12"
                                       value="1" {{isset($certificate) && $certificate->certificate_no==1?"checked":""}}>
                                <span class="checkmark mr-2"></span> {{__('certificate.Yes')}}</label>
                        </div>
                        <div class="col-md-6 mb-25">
                            <label for="no12" class="primary_checkbox d-flex mr-12">
                                <input onclick="getNew()" type="radio"
                                       class="common-checkbox certificate_no" name="certificate_no" id="no12"
                                       value="0" {{isset($certificate) && $certificate->certificate_no!=1?"checked":""}}>
                                <span class="checkmark mr-2"></span> {{__('certificate.No')}}</label>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="input-effect">
                                ...
                                <select class="primary_select certificate_no_font_family" onchange="getNew()"
                                        ...
                                        name="certificate_no_font_family">
                                    @foreach($font_list as $key=>$value)
                                        <option
                                            value="{{$key}}" {{isset($certificate)?$certificate->certificate_no_font_family==$key?'selected':'':''}}>
                                            {{$value}}
                                        </option>
                                    @endforeach
                                </select>
