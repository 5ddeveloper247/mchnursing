            ...
            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mt-20">
                                        ...
                                        <select class="primary_select" name="group" id="">
                                            <option data-display="{{ __('quiz.selectGroup') }}" value="">
                                                {{ __('quiz.selectGroup') }}</option>
                                            @foreach ($groups as $group)
                                                <option value="{{ $group->id }}"
                                                    {{ $group->id == $searchGroup ? 'selected' : '' }}> {{ $group->title }}
                                                </option>
                                            @endforeach
                                        </select>
                ...
                <div class="col-lg-8 mt--1">
                    ...
                    {{ Form::open([
                        ...
                        'files' => true,
                        'route' => 'online_exam_question_assign',
                        'method' => 'POST',
                    ...
                    <div class="QA_section QA_section_heading_custom check_box_table">
                        <div class="QA_table">
                            <table id="lms_table" class="quiz_assign_table table">
                                <thead>
                                    ...
                                    <tr>
                                        <th>
                                            ...
                                            <label class="primary_checkbox d-flex" for="questionSelectAll">
                                                <input type="checkbox" id="questionSelectAll" value=""
                                ...
                                <tbody>
                                    ...
                                    @foreach ($question_banks as $question_bank)
                                        ...
                                        <tr class="abc">
                                            ...
                                            <td>{{ @$question_bank->questionGroup != '' ? @$question_bank->questionGroup->title : '' }}
                                            </td>
                                            <td>
                                                @php
