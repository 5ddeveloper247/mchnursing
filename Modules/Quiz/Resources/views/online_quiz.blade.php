                                    ...
                                    <div class="row mb-25 mt-25 default-settings"
                                        ...
                                        <div class="col-lg-12   ">
                                            <ul class="permission_list">
                                                <li>
                                                    ...
                                                    <label class="mb-0"
                                                           for="#show_ans_with_explanation">{{trans('quiz.Same Page Show Question & Explanation')}} </label>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-lg-12   ">
                                                ...
                                                <li>
                                                    <label class="primary_checkbox d-flex mr-12 text-nowrap ">
                                                        <input
                                                            ...
                                                            @if (@$losing_focus_acceptance_number>0) checked
                                                            @endif
                                                            value="1"
                                                            type="checkbox"
                                                        >
                                        ...
                                        <div class="col-lg-12 losing_total_count_div">
                                            ...
                                            <input class="primary_input_field name"
                                                   ...
                                                   value="{{$losing_focus_acceptance_number??0}}"
                                                   type="number">
                                        </div>
