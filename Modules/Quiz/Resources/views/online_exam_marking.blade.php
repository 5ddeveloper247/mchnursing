                                                                                ...
                                                                                @foreach ($question['option'] as $option)
                                                                                    ...
                                                                                    @else
                                                                                        @if (isset($option['wrong']) && $option['wrong'])
                                                                                            <li>
                                                                                                <label
                                                                                                    class="primary_checkbox d-flex error_ans mr-12"
                                                                                                    style="padding: 15px">
                                                                                                    <input checked=""
                                                                                                        type="checkbox"
                                                                                                        disabled>
                                                                    ...
                                                                    <div class="marking_img">
                                                                        @if (isset($question['isSubmit']))
                                                                            @if (isset($question['isWrong']) && $question['isWrong'])
                                                                                <img src="{{ asset('public/backend/') }}/img/wrong.png"
                                                                                    alt="">
                                                                            @else
                                                                                <img src="{{ asset('public/backend/') }}/img/correct.png"
                                                                                    alt="">
                                                                            @endif
                                                                            <input type="hidden"
