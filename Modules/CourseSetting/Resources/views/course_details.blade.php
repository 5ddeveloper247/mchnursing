                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div class="row d-flex">
                                                                <div class="col-lg-2">
                                                                    ...
                                                                    <button
                                                                        class="primary-btn icon-only fix-gr-bg mr-10"
                                                                        id="minus_option_box" style="display: none">X
                                                                    </button>
                                                                </div>
                                                                <div class="col-lg-10">
                                                                    <div class="lms_option_box d-flex">
                                                                        <div class="pb-30 lms_option_list pt-20"
                                                                             style="display: none">
                                                                            <div
                                        ...
                                        <div class="white_box_30px pl-0 pr-0 pt-0">
                                            <form action="{{ route('AdminUpdateCourse') }}" method="POST"
                                                ...
                                                <div class="row">
                                                            ...
                                                            <div class="row toggle_course_testPrep">
                                                                ...
                                                                <div class="col-md-4 col-sm-4 mb-25">
                                                                    <label class="primary_checkbox d-flex mr-12"
                                                                           onclick="removecol()">
                                                                        <input type="radio" id="type{{ @$course->id }}1"
                                                                               name="type"
                                                                               value="1"
                                                                ...
                                                                <div class="col-md-4 col-sm-4 mb-25">
                                                                    <label class="primary_checkbox d-flex mr-12 nowrap" onclick="timecol()">
                                                                        <input type="radio" id="type2"
                                                                               name="type"
                                                                               value="7"  {{ @$course->type == 7 ? 'checked' : '' }}>
                                                                        <span class="checkmark mr-2"></span> {{__('Time Table')}}</label>
                                                                </div>
                                                                <div class="col-md-4 col-sm-4 mb-25">
                                                                    <label class="primary_checkbox d-flex mr-12 nowrap"
                                                                           onclick="addcol()">
                                                                        <input type="radio" id="type{{ @$course->id }}2"
                                                                               name="type"
                                                                               value="2" {{ @$course->type == 2 ? 'checked' : '' }} {{ auth()->user()->role_id == 2 ? 'disabled' : '' }}>
                                                                        <span
                                                                            class="checkmark mr-2"></span> {{__('Big Quiz')}}
                                                                    </label>
                                                                </div>
                                                                <script>
                                                                    function addcol(){
                                                    ...
                                                    @php
                                                        $cna_prep_price = \Modules\CourseSetting\Entities\Course::where('type',4)->where('parent_id',$course->id)->first(['price'])->price ?? "0.00"
                                                    @endphp
                                                    @php
                                                        $test_prep_price = \Modules\CourseSetting\Entities\Course::where('type',5)->where('parent_id',$course->id)->first(['price'])->price ?? "0.00"
                                                    @endphp
                                                    @php
                                                        $test_prep_graded_price = \Modules\CourseSetting\Entities\Course::where('type',6)->where('parent_id',$course->id)->first(['price'])->price ?? "0.00"
                                                    @endphp
                                                    ...
                                                    <div class="col-xl-6 courseBox">
                                                        <div class="primary_input">
                                                            <div class="row toggle_course_testPrep">
                                                                ...
                                                                <div class="col-md-4 col-sm-4 mb-25">
                                                                    <label
                                                                        class="primary_checkbox d-flex mr-12 nowrap ">
                                                                        <input type="checkbox"
                                                                               name="test_prep_type"
                                                                               onchange="showPrepDemandPrice()"
                                                                               value="1"
                                                                            {{ $test_prep_price != "0.00" ? 'checked' :'' }}>
                                                                        <span
                                                                            class="checkmark mr-2"></span> {{__('Test-Prep(on-demand)')}}
                                                                    </label>
                                                                </div>
                                                                <div class="col-md-4 col-sm-4 mb-25">
                                                                    <label
                                                                        ...
                                                                        <input type="checkbox"
                                                                               ...
                                                                               value="1"
                                                                            {{ $test_prep_graded_price != "0.00"? 'checked' :'' }}>
                                                                        <span
                                                                            class="checkmark mr-2"></span> {{__('Test-Prep(live)')}}
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id="cna_prep_type" class="col-xl-6  {{ $cna_prep_price != "0.00" ? '' :'d-none' }}">
                                                        <div class="primary_input mb-25">
                                                            ...
                                                            <input class="primary_input_field" name="cna_prep_price"
                                                                   ...
                                                                   type="text" value="{{ @$cna_prep_price != "0.00" ? @$cna_prep_price :null }}">
                                                        </div>
                                                    </div>

                                                    <div id="test_prep_type" class="col-xl-6  {{ $test_prep_price != "0.00" ? '' :'d-none' }} ">
                                                        <div class="primary_input mb-25">
                                                            <label class="primary_input_label"
                                                            ...
                                                            <input class="primary_input_field" name="test_prep_price"
                                                                   ...
                                                                   type="text" value="{{ @$test_prep_price != "0.00" ? @$test_prep_price :null }}">
                                                        </div>
                                                    </div>

                                                    <div id="test_prep_graded_type" class="col-xl-6   {{ $test_prep_graded_price != "0.00"? '' :'d-none' }}">
                                                        <div class="primary_input mb-25">
                                                            <label class="primary_input_label"
                                                                   for="">{{ __('TEST PREP Price(Live)') }}</label>
                                                            <input class="primary_input_field"
                                                                   name="test_prep_graded_price" placeholder="-"

                                                                   type="text" value="{{ @$test_prep_graded_price  != "0.00" ? @$test_prep_graded_price :null }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6 courseBox {{ $course->type == 7 ? 'd-none' : '' }}">
                                                        <div class="primary_input mb-25">
                                                            <label class="primary_input_label"
                                                                   for="assistant_instructors">{{__('Total Classes')}} </label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    {{--                                                        <label class="primary_input_label toggle_course_quiz mt-1"--}}
                                                    {{--                                                            for="">--}}
                                                    ...
                                                    {{--                                                                    <span--}}
                                                    {{--                                                                        class="checkmark mr-2"></span>{{ __('Test-Prep') }}--}}
                                                    {{--                                                                </label>--}}
                                                    {{--                                                            </div>--}}
                                                    {{--                                                        </div>--}}
                                                    ...
                                                    @if (\Illuminate\Support\Facades\Auth::user()->role_id != 2)
                                                        <div class="col-xl-6 {{ $course->type == 7 ? 'd-none' : '' }}">
                                                            <div class="primary_input mb-25">
                                                                <label class="primary_input_label"
                                                ...
                                                <div class="col-xl-12 p-0">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6 quizBox mb-25" style=" display: none">
                                                            <select class="primary_select" name="quiz" id="quiz_id">
                                                                <option
                                                                    data-display="{{ __('common.Select') }} {{ __('Test-Prep') }}"
                                                                    value="">{{ __('common.Select') }}
                                                                    {{ __('Test-Prep') }} </option>
                                                        ...
                                                        <div class="col-xl-4   timetableBox mt-30 {{ $course->type == 7 ? '' : 'd-none' }}" >
                                                            <select class="primary_select" name="timetable"
                                                                    id="quiz_id" {{$errors->has('timetable') ? 'autofocus' : ''}}>
                                                                <option data-display="{{__('common.Select')}} {{__('Time Table')}} *"
                                                                        value="">{{__('common.Select')}} {{__('Time Table')}} </option>
                                                                @foreach($timetables as $timetable)
                                                                    <option  @if ($timetable->id == $course->time_table_id) selected @endif value="{{$timetable->id}}">{{@$timetable->name}} </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-xl-6 courseBox mb-25 d-none">
                                                        <div class="primary_input">
                                                    ...
                                                    @if (showEcommerce())
                                                        <div class="row mt-20">
                                                            ...
                                                            @endphp --}}
                                                            <div
                                                                class="col-xl-6 {{ $course->type == 2 ? ' d-block' : 'd-none' }}"
                                                                id="edit_price_div">
                                                                <div class="primary_input mb-25">
                                                                    <label class="primary_input_label mt-1"
                                                                ...
                                                                <div class="primary_file_uploader">
                                                                    ...
                                                                    <button class="" type="button">
                                                                        ...
                                                                        <input type="file" class="d-none fileUpload"
                                                                               name="image" id="3_document_file_33">
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        </div>
