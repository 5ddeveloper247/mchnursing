                ...
                <div class="single_permission" id="chapter_id{{ $key }}">
                    <div class="permission_header d-flex align-items-center justify-content-between">
                        ...
                        <div class="mr-20 mt-1">
                            ...
                            <a href="#"
                                data-url="{{ url('admin/course/delete-chapter/' . $chapter->id . '/' . $course->id) }}"
                                class="chapter_icon deleteChapterBtn mr-20">
                        ...
                        @if (isset($data['chapter_id']))
                            @if ($data['chapter_id'] == $chapter->id)
                                <div class="arrow" data-toggle="collapse"
                                    data-target="#Rolechapter_id{{ $key }}" aria-expanded="true">
                                @else
                ...
                <div id="Rolechapter_id{{ $key }}"
                    ...
                    <div class="row d-flex mt-30 pl-20">
                        <div class="col-lg-2">
                            ...
                            <button class="primary-btn icon-only fix-gr-bg minus_option_box mr-10"
                        ...
                        <div class="col-lg-10">
                            <div class="lms_option_box d-flex">
                                <div class="pb-30 lms_option_list_inside pt-20" id="lms_option_list{{ $key }}"
                                    style="display: none">
                                    <div class="add-item-forms--inline-menu--1OTdc">
                                        ...
                                        @if (isModuleActive('Assignment'))
                                            <button data-purpose="add-chapter-btn" aria-label="Add Assignment"
                                                type="button" data-chapter="{{ $key }}"
                    ...
                    <div class="permission_body nastable2" data-chapter="{{ $chapter->id }}">
                        @foreach ($chapter->lessons as $key => $lesson)
                            @if ($key == 0)
                                <div class="row mb-40" id="add_question_section_inside{{ $chapter->id }}"
                                    style="display: none">
                                    <div class="col-lg-1"></div>
                                    <div class="col-lg-10 section_content">
                                ...
                                <div class="row" id="edit_question{{ $lesson->id }}">
                                    ...
                                    <div class="col-lg-10 section_content">
                                        ...
                                        @else
                                            ...
                                            @endphp
                                            @include(
                                                'coursesetting::parts_of_course_details.lesson_section_inside',
                                                compact('editSection'))
                                        @endif
                                    </div>
                                    <div class="col-lg-1"></div>
                            ...
                            <div class="child" data-id="{{ $lesson->id }}">
                                <div
                                    class="single_capter_list d-flex align-items-center justify-content-between mt-10 flex-wrap">
                                    @if ($lesson->is_quiz == 1)
                                        @foreach ($lesson->quiz as $quiz_key => $quiz)
                                            <span class="flex-fill"> <i class="ti-move"></i> <span
                                                    class="serial">{{ $key + 1 }}</span>.
                                                {{ @$quiz->title }}</span>
                                            <a class="primary-btn icon-only fix-gr-bg quiz_inside_icon collapsed mr-10"
                                            ...
                                            <div class="w-100 collapse mt-10"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <a
                                                                                href="{{ url('admin/course/course-question-show/' . $assign->questionBank->id . '/' . $course->id . '/' . $chapter->id . '/' . $lesson->id) }}"><i
                                                                                    class="ti-pencil-alt"></i>
                                                                            </a>
                                                                            <a href="{{ route('CourseQuestionDelete', ['quiz_id' => $quiz->id, 'question_id' => $assign->questionBank->id]) }}   "
                                                                                class="ml-10" title="Delete"><i
                                                                                    class="ti-trash"></i>
                                                                            </a>
                                    ...
                                    @elseif($lesson->is_assignment == 1)
                                        ...
                                        @endforeach
                                    @else
                                        <span> <i class="ti-move"></i> <span
                                                class="serial">{{ $key + 1 }}</span>. {{ $lesson['name'] }}
                                            [{{ MinuteFormat($lesson['duration']) }}]
                                            [{{ $lesson->is_lock == 0 ? 'unlock' : 'Lock' }}]</span>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                @if (isModuleActive('Org') && selfHosted($lesson->host) && !empty($lesson->org_material_id))
                                                    <a href="{{ route('org.material.files', $lesson->org_material_id) }}"
                                                        type="button" class="dropdown-item btn-modal"
...
<div class="modal fade admin-query" id="deleteChapter">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex justify-content-between mt-40">
                    ...
                    <a href="#" class="primary-btn fix-gr-bg deleteChapterModalUrl"
