                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="primary_input">
                                <div class="row toggle_course_testPrep">
                                    ...
                                    <div class="col-md-4 col-sm-4 mb-25">
                                        <label class="primary_checkbox d-flex mr-12 nowrap" onclick="addcol()">
                                            <input type="radio" id="type2"
                                                   name="type"
                                                   value="2" {{old('type')==2?"checked":""}} {{ auth()->user()->role_id == 2 ? 'disabled' : '' }}>
                        ...
                        <div id="cna_prep_type"  class="col-xl-6 d-none" >
                            <div class="primary_input mb-25">
                                ...
                                <input class="primary_input_field" name="cna_prep_price" placeholder="-"

                                       type="text" value="{{old('cna_prep_price')}}">
                            </div>
                        </div>
                        <div id="test_prep_type"  class="col-xl-6 d-none" >
                            <div class="primary_input mb-25">
                                ...
                                <input class="primary_input_field" name="test_prep_price" placeholder="-"

                                       type="text" value="{{old('test_prep_price')}}">
                            </div>
                        </div>
...
<!-- wwwwwwwwwwww -->
                                ...
                                <div class="row">
                                    <div
                                        ...
                                        <div class="primary_input mb-25">
                                            ...
                                            <input class="primary_input_field" name="{{ $language->code == 'en' ? 'title':'' }}"
                                                   placeholder="-"
                                                   id="addTitle"
                    ...
                    <div class="row ">
                        ...
                        <div class="col-xl-6   testPrepBox mt-30 d-none" >
                            <select class="primary_select" name="quiz"
                                ...
                                <option data-display="{{__('common.Select')}} {{__('Test-Prep')}} *"
                                        value="">{{__('common.Select')}} {{__('Test-Prep')}} </option>
                    ...
                    @if(showEcommerce())
                        ...
                        <div class="row mt-20 d-none" id="discountDiv">
                            <div class="col-lg-6">
                                <div class="checkbox_wrap d-flex align-items-center mt-40">
                    ...
                    <div class="row mt-20 mb-10 videoOption d-none">
